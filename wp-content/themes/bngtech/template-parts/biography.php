...
$facebook_url = get_the_author_meta( 'bngtech_facebook');
$twitter_url = get_the_author_meta( 'bngtech_twitter');
$linkedin_url = get_the_author_meta( 'bngtech_linkedin');
$instagram_url = get_the_author_meta( 'bngtech_instagram');
$bngtech_url = get_the_author_meta( 'bngtech_youtube');
$bngtech_write_by = get_the_author_meta( 'bngtech_write_by');
...
?>
        <div class="theme-author mt-50 mb-40">
            ...
            <div class="author__text">
                <span><?php print esc_html($bngtech_write_by); ?></span>
                ...
                <div class="author-icon">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($bngtech_url)) : ?>
                    <a href="<?php print esc_url($bngtech_url); ?>" target="_blank" ><i class="fab fa-youtube"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
