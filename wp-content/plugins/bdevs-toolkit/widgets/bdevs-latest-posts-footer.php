...
Class Latest_posts_footer_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts-footer', 'TechBuzz Footer Posts Image', array(
	     	...
	     	<div class="recent-posts recent-posts-footer">
				...
				?>
		            <div class="widget-post-list fix">
		                ...
		                <div class="widget-posts-image" data-background="<?php the_post_thumbnail_url(); ?>"></div>
		                <?php endif; ?>
