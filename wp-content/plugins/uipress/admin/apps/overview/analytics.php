...
class uipress_analytics
{
  ...
  public function register_analytics_cards($cards)
  {
    ...
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/page-views.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/page-speed.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/site-users.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/site-devices.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/bounce-rate.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/session-duration.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/country-visits.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/traffic-sources.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Analytics", "admin2020");
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/analytics/page-traffic.min.js";
    $cards[] = $temp;
  ...
  public function admin2020_get_analytics_request($startdate = null, $enddate = null)
  {
    ...
    error_log("https://admintwentytwenty.com/analytics/fetch.php?code=" . $code . "&view=" . $view . "&sd=" . $startdate . "&ed=" . $enddate);
