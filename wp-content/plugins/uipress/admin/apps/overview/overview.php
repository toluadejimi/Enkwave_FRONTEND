...
class uipress_overview
{
  ...
  public function register_default_cards($cards)
  {
    ...
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/recent-posts.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/recent-comments.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/system-info.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/site-health.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/calendar.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/custom-video.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/shortcode.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("General", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/general/custom-html.min.js";
    $cards[] = $temp;
  ...
  public function build_overview()
  {
    ?>
		...
		<div class="wrap uip-padding-m uip-text-normal uip-body-font uip-fade-in" id="overview-app">
  ...
  public function build_cards()
  {
    ?>
		<div v-for='(category, index) in cardsWithIndex' class="uip-margin-top-m uip-margin-bottom-m" :class="{'uip-border-dashed uip-padding-s uip-border-round uip-margin-top-l' : ui.editingMode}">
			...
			:class="{'uip-background-default uip-shadow uip-border uip-padding-s' : !category.open}">
				<div class="uip-flex" >
			...
			<div v-if="category.open" class="uip-grid uip-margin-top-m">
