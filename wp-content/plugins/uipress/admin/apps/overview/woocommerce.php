...
class uipress_woocommerce
{
  ...
  public function register_analytics_cards($cards)
  {
    ...
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/woocommerce/total-sales.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Commerce", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/woocommerce/total-orders.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Commerce", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/woocommerce/average-order-value.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Commerce", $this->textDomain);
    $temp["premium"] = true;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/woocommerce/recent-orders.min.js";
    $cards[] = $temp;
    ...
    $temp["category"] = __("Commerce", $this->textDomain);
    $temp["premium"] = false;
    $temp["componentPath"] = $this->pathURL . "admin/apps/overview/modules/woocommerce/popular-products.min.js";
    $cards[] = $temp;
