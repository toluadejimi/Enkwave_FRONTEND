...
class uipress_styles
{
  ...
  public function add_scripts_and_styles()
  {
    ...
    //wp_enqueue_script("uip-color-picker", $this->pathURL . "assets/js/vue-color/vue-color.min.js", ["uip-app"], $this->version, true);
  }
  ...
  public function get_styles_object()
  {
    ...
    $temp = [];
    $temp["name"] = __("Toolbar Text Color", $this->textDomain);
    $temp["type"] = "color";
