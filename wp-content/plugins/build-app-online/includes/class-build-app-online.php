...
class Build_App_Online {
	...
	private function define_public_hooks() {
        ...
        $this->loader->add_action('wp_ajax_build-app-online-add_wishlist', $plugin_public, 'add_wishlist');
        $this->loader->add_action('wp_ajax_nopriv_build-app-online-add_wishlist', $plugin_public, 'add_wishlist');
