...
class Build_App_Online_Public {
    ...
    public function dotapp()
    {
        ...
        foreach ($dotapp_blocks as $key => $value) {
            ...
            if($locale != 'en' && isset($data['locale'][$dotapp_blocks[$key]['title']])) {
        ...
        $data['settings'] = array(
            ...
            'teraWallet' => (bool)$options['enable_wallet'],
            ...
            'isMultivendor' => (bool)$options['is_multivendor'],
            'enableHomeTabBar' => (bool)$options['home_tab_bar'],
            'showBottomTabLabels' => (bool)$options['bottom_tab_labels'],
            'listingAddToCart' => (bool)$options['add_to_cart_buttons'],
            'home' => (string)$options['home_type'],
            'labels' => (array)explode(',', $options['labels']),
            'footerAddToCartButton' => (bool)$options['footerAddToCartButton'],
            'accountChatType' => (string)$options['accountChatType'],
            'facebookPage' => (string)$options['facebookPage'],
            'dynamic_link' => (string)$options['dynamic_link'],
            'popular_searches' => (array)explode(',', $options['popular_searches']),
            'showHomeStoreList' => (bool)$options['showHomeStoreList'],
            'enableReferral'    => (bool)$options['enableReferral'],
            'enableDownloads' => (bool)$options['enable_downloads'],
            'enableStoreTab'    => (bool)$options['enableStoreTab'],
            'geoLocation' => (bool)$options['geoLocation'],
        );
    ...
    public function store_details()
    {
        ...
        } else if($options['switch_category_location_filter'] == '1') {
            $data['categories'] = $this->get_nearby_categories();
        } else {
            $data['categories'] = $this->get_categories();; 
        }
    ...
    public function create_user(){
        ...
        if(isset($_REQUEST['email']) && isset($_REQUEST['first_name']) && isset($_REQUEST['last_name']) && isset($_REQUEST['phone'])) {
    ...
    public function get_wc_marketplace_vendor_list(){
        ...
        $args = array(
            ...
            'offset' => ( $_REQUEST['page'] - 1 ) * absint($_REQUEST['per_page'])
        );
