    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .brand__carousel .brand' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    <?php else: ?>
        <section class="brand__area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="brand__carousel owl-carousel">
                            <?php foreach ($settings['slides'] as $slide) :
                                ...
                                <div class="brand">
                                    <img src="<?php print esc_url($image); ?>" alt="brand">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
