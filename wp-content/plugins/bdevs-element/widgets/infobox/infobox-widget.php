...
class InfoBox extends BDevs_El_Widget
{
        ...
        if (bdevs_element_is_elementor_version('<', '2.6.0')) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'condition' => [
                        'design_style' => ['style_1', 'style_3', 'style_6', 'style_7']
                    ]
                ]
            );
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .case-studies-content, {{WRAPPER}} .process__box--content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .case-studies-img .case-studies-text span, {{WRAPPER}} .process__box--content span' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .case-studies-img .case-studies-text span, {{WRAPPER}} .process__box--content span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .case-studies-img .case-studies-text span, {{WRAPPER}} .process__box--content span',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .case-studies-img .case-studies-text h3, {{WRAPPER}} .process__box--content .title, {{WRAPPER}} .feature__box .title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .case-studies-img .case-studies-text h3 a, {{WRAPPER}} .process__box--content .title a, {{WRAPPER}} .feature__box .title, {{WRAPPER}} .feature__box .title span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'bdevselement'),
                'selector' => '{{WRAPPER}} .case-studies-img .case-studies-text h3, {{WRAPPER}} .process__box--content .title, {{WRAPPER}} .feature__box .title',
                'scheme' => Scheme_Typography::TYPOGRAPHY_2
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .case-studies-content p,{{WRAPPER}} .process__box--content p,{{WRAPPER}} .feature__box p' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .case-studies-content p,{{WRAPPER}} .process__box--content p,{{WRAPPER}} .feature__box p' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'bdevselement'),
                'selector' => '{{WRAPPER}} .case-studies-content p,{{WRAPPER}} .process__box--content p,{{WRAPPER}} .feature__box p',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn,{{WRAPPER}} .process__box--thumb .site-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'btn_typography',
                'selector' => '{{WRAPPER}} .button-wrapper .site-btn,{{WRAPPER}} .process__box--thumb .site-btn',
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn,{{WRAPPER}} .process__box--thumb .site-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn, {{WRAPPER}} .button-wrapper .site-btn span,{{WRAPPER}} .process__box--thumb .site-btn' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn,{{WRAPPER}} .process__box--thumb .site-btn' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn:hover, {{WRAPPER}} .button-wrapper .site-btn:hover span, {{WRAPPER}} .button-wrapper .site-btn:focus, {{WRAPPER}} .button-wrapper .site-btn:focus span,{{WRAPPER}} .process__box--thumb .site-btn:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn:hover,{{WRAPPER}} .process__box--thumb .site-btn:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .button-wrapper .site-btn:hover, {{WRAPPER}} .button-wrapper .site-btn:focus,{{WRAPPER}} .process__box--thumb .site-btn:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if (!empty($settings['button_link'])) {
            $this->add_render_attribute('button', 'class', 'site-btn transparent white');
        ...
        <div class="feature__box">
            <?php printf('<%1$s class="title">%2$s</%1$s>',
    ...
    <?php elseif ($settings['design_style'] === 'style_2'):
        ...
        <div class="process__box">
            ...
            <div class="process__box--content">
                ...
                <?php endif; ?>
                <?php printf('<%1$s class="title"><a href="%2$s">%3$s</a></%1$s>',
                    tag_escape($settings['title_tag']),
    ...
    <?php else:
        ...
        <div class="case-studies-wrapper mb-30">
            <div class="case-studies-img">
                <?php if (!empty($image)): ?>
                    <img src="<?php print esc_url($image); ?>" alt="Logo">
                <?php endif; ?>
